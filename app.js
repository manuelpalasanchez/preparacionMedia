...
const TYPE_LABEL = {z2a:'Z2', z2b:'Z2', series:'Series', tirada:'Tirada', carrera:'Carrera', descanso:'Descanso'};
...
function renderCalendario(){
  ...
  html += `<div class="legend">
    <div class="legend-item"><span class="legend-dot" style="background:var(--z2)"></span>Z2</div>
...
function renderGraficos(){
  ...
  chartTypeInstance = new Chart(ctx3, {
    type:'bar',
    data:{
      labels:['Z2 (A+B)','Series/calidad','Tiradas largas','Carrera'],
      datasets:[{
